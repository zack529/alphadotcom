...
const devices: Device[] = [
  { name: "Alpha's MacBook Air", model: "This MacBook Air", type: "macbook" },
  { name: "Alpha's iPhone 16 Pro", model: "iPhone 16 Pro", type: "iphone" },
  { name: "Alpha's iPad", model: "iPad Air", type: "ipad" },
